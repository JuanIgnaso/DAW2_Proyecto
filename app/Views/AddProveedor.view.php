    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="table-responsive text-center" style="min-height: 1000px; max-height: auto;">
          ...
          <div class="row row-cols-1 m-0 row-cols-sm-2 row-cols-lg-3">
              ...
              <input type="hidden" id="postId" name="id_proveedor" value="<?php echo isset($input['id_proveedor']) ? $input['id_proveedor'] :'';?>" />
              <div class="col d-flex flex-column">
                 <label for="">Nombre</label>
                <input type="text" id="nombre_proveedor" name="nombre_proveedor" value="<?php echo isset($input['nombre_proveedor']) ? $input['nombre_proveedor'] : '' ;?>" class="mt-1">
                 <p class="text-danger small"><?php echo isset($errores['nombre_proveedor']) ? $errores['nombre_proveedor'] : '';?></p>
              </div>
              ...
              <div class="col d-flex flex-column">
                ...
                <p class="text-danger small"><?php echo isset($errores['direccion']) ? $errores['direccion'] : '';?></p>
             </div>
                                                   
              <div class="col d-flex flex-column">
                 <label for="">Website</label>
                <input type="text" id="website" name="website" value="<?php echo isset($input['website']) ? $input['website'] : '' ;?>" class="mt-1">
                <p class="text-danger small"><?php echo isset($errores['website']) ? $errores['website'] : '';?></p>
             </div>
            ...
            <div class="col d-flex flex-column">
                ...
                <p class="text-danger small"><?php echo isset($errores['email_proveedor']) ? $errores['email_proveedor'] : '';?></p>
            </div>
                 
              <div class="col d-flex flex-column">
                 <label for="">Telefono</label>
                <input type="text" id="telefono" name="telefono" value="<?php echo isset($input['telefono']) ? $input['telefono'] : '' ;?>" class="mt-1">
                <p class="text-danger small"><?php echo isset($errores['telefono']) ? $errores['telefono'] : '';?></p>
              </div>
