    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Panel Administración: <?php echo isset($tipo) ? $tipo : 'Categoría';?></h1>
             <a href="/inventario/Monitores/add" class="btn btn-success ml-1">Añadir<i class="fa-solid fa-circle-plus p-1"></i></a>
      ...
      <div class="table-responsive text-center" style="min-height: 1000px; max-height: auto;">
        ...
        ?>   
          ...
          <div class="col d-flex flex-column">
              ...
              <div class="col d-flex flex-column">
                 <label for="tecnologias">Tecnologia</label>
                    <select name="tecnologias[]" id="tecnologias" multiple>
                           ...
                           ?>
                           <option value="<?php echo $tecnologia['id_tecnologia'];?>"<?php echo (isset($_GET['tecnologias']) && in_array($tecnologia['id_tecnologia'], $_GET['tecnologias'])) ? 'selected' : ''; ?>><?php echo $tecnologia['id_tecnologia'].' - '.$tecnologia['nombre_tecnología'] ;?></option>
            ...
            <div class="col d-flex flex-column">
                 <label for="">Tasa de refresco</label>
                    <select name="refrescos[]" id="refrescos" multiple>
                           <option value="">-</option>
                           
                           <?php
                           foreach ($refrescos as $refresco) {
                           ?>
                           <option value="<?php echo $refresco['refresco'];?><?php echo (isset($_GET['refrescos']) && in_array($refresco['refresco'], $_GET['refrescos'])) ? 'selected' : ''; ?>"><?php echo $refresco['refresco'];?></option>
        ...
        <table class="table table-striped table-sm"  id="tabla_contenido">
          <thead>
            <tr>
              ...
              <th scope="col"><a href="<?php echo $seccion;?>?order=5<?php echo $queryString; ?>">Video</a></th>
              <th scope="col"><a href="<?php echo $seccion;?>?order=6<?php echo $queryString; ?>">Refresco</a></th>
              <th scope="col"><a href="<?php echo $seccion;?>?order=7<?php echo $queryString; ?>">Tecnología</a></th>
          ...
          <tbody>
           ...
           ?>   
            <tr id="<?php echo $producto['codigo_producto'];?>">
              ...
              <td><?php echo $producto['entrada_video'];?></td>
              <td><?php echo $producto['refresco'];?></td>
              <td><?php echo $producto['nombre_tecnología'];?></td>
              <td>
                  <div class="acciones col-12 f-flex justify-content-center gap-1 flex-column flex-sm-row">
                      ...
                      <a href="/inventario/Monitores/edit/<?php echo  $producto['codigo_producto'];?>"class="btn p-0"><i class="fa-solid fa-square-pen" style="color: #8000ff;"></i></a>
                  </div>
              </td>
            </tr>
            <?php
