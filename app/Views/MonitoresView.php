...
<!--          <div class="btn-group me-2">
      ...
      <div class="table-responsive text-center" style="min-height: 1000px; max-height: auto;">
          ...
          <div class="row row-cols-1 m-0 row-cols-sm-2 row-cols-lg-3">
           ...
           <div class="col d-flex flex-column">
                 <label for="">Min Refresco</label>
                <input type="text" id="country" name="min_refresco" value="" class="mt-1">
           </div>
              
              
              <div class="col d-flex flex-column">
                 <label for="">Max Refresco</label>
                <input type="text" id="country" name="max_refresco" value="" class="mt-1">
            </div>  
            ...
            <div class="col d-flex flex-column">
              ...
              <div class="col d-flex flex-column">
                 <label for="">Tecnologia</label>
                    <select name="tecnologia" id="cars">
                           <option value="">-</option>
                           
                           <?php
                           foreach ($tecnologias as $tecnologia) {
                           ?>
                           <option value="<?php echo $tecnologia['id_tecnologia'];?>"><?php echo $tecnologia['id_tecnologia'].' - '.$tecnologia['nombre_tecnología'] ;?></option>
