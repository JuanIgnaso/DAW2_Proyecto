  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="/inventario/Ordenadores/add" class="btn btn-success ml-1">Añadir<i class="fa-solid fa-circle-plus p-1"></i></a>
        ...
        ?>    
          ...
          <section class="row row-cols-1 m-0 row-cols-sm-2 row-cols-lg-3">
              ...
              <div class="col d-flex flex-column">
                  ...
                  <div class="col d-flex flex-column">
                     <label for="memorias">Memoria</label>
                  ...
                  <div class="col d-flex flex-column">
                     <label for="almacenamientos">Almacenamiento</label>
        ...
        <table class="table table-striped table-sm"  id="tabla_contenido">
          <thead>
            <tr>
              ...
              <th scope="col"><a href="<?php echo $seccion;?>?order=5<?php echo $queryString; ?>">CPU</a></th>    
            ...
            <tr id="<?php echo $producto['codigo_producto'];?>">
              ...
              <td>
                  <div class="acciones col-12 f-flex justify-content-center gap-1 flex-column flex-sm-row">
                      ...
                      <a href="/inventario/Ordenadores/edit/<?php echo $producto['codigo_producto'];?>"class="btn p-0"><i class="fa-solid fa-square-pen" style="color: #8000ff;"></i></a>
                  </div>
              </td>
            </tr>
            <?php
