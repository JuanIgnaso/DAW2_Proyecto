  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        <h1 class="h2">Panel Administración: Proveedores</h1>
        <a href="/inventario/Proveedores/add" class="btn btn-success ml-1">Añadir<i class="fa-solid fa-circle-plus p-1"></i></a>

      </div>

      <!--<canvas class="my-4 w-100" id="myChart" width="900" height="380"></canvas>-->
        
      <h2>Filtros de búsqueda Proveedor.</h2>
      ...
      <div class="table-responsive text-center" style="min-height: 1000px; max-height: auto;">
          ...
          <div class="row row-cols-1 m-0 row-cols-sm-2 row-cols-lg-3">
              <div class="col d-flex flex-column">
                ...
                <input type="text" id="nombre_proveedor" name="nombre_proveedor" value="<?php echo isset($input['nombre_provedor']) ? $input['nombre_proveedor'] : '' ;?>" class="mt-1">
            </div>
              
              
             <div class="col d-flex flex-column">
                 <label for="">Dirección</label>
                <input type="text" id="direccion" name="direccion" value="<?php echo isset($input['direccion']) ? $input['direccion'] : '' ;?>" class="mt-1">
            </div>
              
            <div class="col d-flex flex-column">
                 <label for="">Correo</label>
                <input type="text" id="email_proveedor" name="email_proveedor" value="<?php echo isset($input['email_proveedor']) ? $input['email_proveedor'] : '' ;?>" class="mt-1">
            </div>  
        ...
        <table class="table table-striped table-sm" id="tabla_contenido">
          <thead>
            <tr>
              ...
              <th scope="col"><a href="<?php echo $seccion;?>?order=3<?php echo $queryString; ?>">Dirección</a></th>
              <th scope="col"><a href="<?php echo $seccion;?>?order=4<?php echo $queryString; ?>">Website</a></th>   
              <th scope="col"><a href="<?php echo $seccion;?>?order=5<?php echo $queryString; ?>">Email</a></th>
              <th scope="col"><a href="<?php echo $seccion;?>?order=6<?php echo $queryString; ?>">Telf.Contacto</a></th>
          ...
          <tbody>
           ...
           ?>   
            <tr id="<?php echo $proveedor['id_proveedor'];?>">
              <td><?php echo $proveedor['id_proveedor'];?></td>
              <td><?php echo $proveedor['nombre_proveedor'];?></td>
              <td><?php echo $proveedor['direccion'];?></td>
              <td><a class="btn" style="font-size:1.25rem;" href="<?php echo $proveedor['website'];?>"><i class="fa-solid fa-square-arrow-up-right" style="color: #8080ff;"></i></a></td>
              ...
              <td>
                  <div class="acciones col-12 f-flex justify-content-center gap-1 flex-column flex-sm-row">
                      ...
                      <a href="/inventario/Proveedores/edit/<?php echo $proveedor['id_proveedor'];?>"class="btn p-0"><i class="fa-solid fa-square-pen" style="color: #8000ff;"></i></a>
                  </div>
              </td>
            </tr>
            <?php
