  ...
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
        ...
        <a href="/inventario/Consolas/add" class="btn btn-success ml-1">Añadir<i class="fa-solid fa-circle-plus p-1"></i></a>
      ...
      <div class="table-responsive text-center" style="min-height: 1000px; max-height: auto;">
        ...
        ?>   
          ...
          <section class="row row-cols-1 m-0 row-cols-sm-2 row-cols-lg-3">
               ...
               <div class="col d-flex flex-column">
                     <label for="juego_incluido">Juego Incluido</label>
              ...
              <div class="col d-flex flex-column">
                ...
                <div class="col d-flex flex-column">
                     <label for="conexiones">Conexion</label>
          ...
          <div class="col-12 d-flex align-items-center justify-content-center  border-bottom border-secondary justify-content-md-end p-3 gap-3">
              <a href="/inventario/Consolas" value="" name="reiniciar" id="reiniciar" class="btn boton-cancelar">Reiniciar filtros</a>
            ...
            <tr  id="<?php echo $producto['codigo_producto'];?>">
              ...
              <td>
                  <div class="acciones col-12 f-flex justify-content-center gap-1 flex-column flex-sm-row">
                      ...
                      <a href="/inventario/Consolas/edit/<?php echo $producto['codigo_producto'];?>"class="btn p-0"><i class="fa-solid fa-square-pen" style="color: #8000ff;"></i></a>
                  </div>
              </td>
            </tr>
            <?php
        ...
        <div class="row m-0">
              <footer class="d-flex pos pie flex-wrap flex-column flex-lg-row justify-content-center align-items-center py-3 my-4" style="margin: 0 !important; z-index:30;">
                  ...
                  <ul class="nav col-md-4 justify-content-center list-unstyled d-flex">
                   ...
                   <!-- Script Paginacion -->
        <script src="/assets/js/paginarElementosTabla"></script>
                <!-- SCRIPT BORRAR -->
